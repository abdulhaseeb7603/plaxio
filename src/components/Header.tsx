...
export function Header({ onSearch }: HeaderProps) {
  ...
  const botLogoUrl = "data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24'%3E%3Cpath d='M12 2a2 2 0 0 1 2 2c0 .74-.4 1.39-1 1.73V7h1a7 7 0 0 1 7 7h1a1 1 0 0 1 1 1v3a1 1 0 0 1-1 1h-1v1a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-1H2a1 1 0 0 1-1-1v-3a1 1 0 0 1 1-1h1a7 7 0 0 1 7-7h1V5.73c-.6-.34-1-.99-1-1.73a2 2 0 0 1 2-2M7.5 13A2.5 2.5 0 0 0 5 15.5A2.5 2.5 0 0 0 7.5 18a2.5 2.5 0 0 0 2.5-2.5A2.5 2.5 0 0 0 7.5 13m9 0a2.5 2.5 0 0 0-2.5 2.5a2.5 2.5 0 0 0 2.5 2.5a2.5 2.5 0 0 0 2.5-2.5a2.5 2.5 0 0 0-2.5-2.5Z'/%3E%3C/svg%3E";
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center space-x-3">
            <span 
              className="inline-block w-6 h-6 bg-black dark:bg-white rotate-180"
              style={{ 
                maskImage: `url("${botLogoUrl}")`, 
                maskSize: 'contain', 
                maskRepeat: 'no-repeat',
                WebkitMaskImage: `url("${botLogoUrl}")`,
          ...
          <div className="flex items-center gap-2">
            ...
            <a
              href="https://www.buymeacoffee.com/dev_abdulhaseeb"
              target="_blank"
            ...
            >
              <span className="hidden md:inline">+ Submit MCP Server</span>
